...
namespace WL3DVirtuaApp
{
    ...
    {
        //Variables      
        static string fileName = ""; // string to be used as the file name for the text file
        ...
        public List<string> PopulateList(string path) // Populates the static list with contents of text file.
        {
            using (StreamReader reader = new StreamReader(path, UnicodeEncoding.GetEncoding("GB2312")))
            {
                string line;
                list.Clear();
